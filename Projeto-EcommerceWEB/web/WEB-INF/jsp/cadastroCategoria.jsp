            ...
            <div class="contanier-cadastro">
                <form action="cadastrar-categoria" class="inputs-cad-prod" method="post" name="formCadastro"
                    ...
                    <div >
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" placeholder="Nome Categoria" name="nome" id="nomeCat">
                        </div>
                    </div>
                ...
                <form action="cadastrar-setor" class="inputs-cad-prod" method="post" name="formCadastro"
                    ...
                    <div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Nome</label>
                            <input class="form-control" type="text" placeholder="Nome Setor" name="nome" id="nomeSet">
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary">Confirmar</button>
                </form>
